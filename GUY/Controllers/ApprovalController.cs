...
namespace GUY.Controllers
{
    ...
    public class ApprovalController : ControllerBase
    {
        ...
        {
            string query = "select ApprovalID, ApprovalName from Approval; ";
        ...
        [HttpPost]
        public JsonResult Post(Approval appr)
        {
            string query = @"
                    insert into dbo.Approval values
                    ('" + appr.ApprovalID + @"',
                     '" + appr.ApprovalName + @"')
                       ";
            DataTable table = new DataTable();
        ...
        [HttpPut]
        public JsonResult Put(Approval appr)
        {
            string query = @"
                    update dbo.Approval set
                    ApprovalID = '" + appr.ApprovalID + @"'
                    ,ApprovalName = '" + appr.ApprovalName + @"'
                    where ApprovalID = " + appr.ApprovalID + @"
                    ";
            DataTable table = new DataTable();
            string sqlDataSource = "Data Source=DESKTOP-2VQEA7I\\MSSQLSERVER01;Initial Catalog=GUY;Integrated Security=True;";
            SqlDataReader myReader;
