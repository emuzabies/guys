...
namespace GUY.Controllers
{
    ...
    public class LeaveTypeController : ControllerBase
    {
        ...
        {
            string query = "select LeaveID, LeaveName from LeaveType; ";
        ...
        [HttpPost]
        public JsonResult Post(Leavetype leavetyp)
        {
            string query = @"
        ...
        [HttpPut]
        public JsonResult Put(Leavetype leavetyp)
        {
            string query = @"
                    update dbo.LeaveType set
                    LeaveID = '" + leavetyp.LeaveID + @"'
                    ,LeaveName = '" + leavetyp.LeaveName + @"'
                    where LeaveID = " + leavetyp.LeaveID + @"
                    ";
            DataTable table = new DataTable();
            string sqlDataSource = "Data Source=DESKTOP-2VQEA7I\\MSSQLSERVER01;Initial Catalog=GUY;Integrated Security=True;";
            SqlDataReader myReader;
