...
namespace GUY.Controllers
{
    ...
    public class ProvinceController : ControllerBase
    {
        ...
        [HttpPost]
        public JsonResult Post(Province prvn)
        {
            string query = @"
                    insert into dbo.Province values
                    ('" + prvn.ProvinceID + @"',
                     '" + prvn.ProvinceName + @"')
                       ";
            DataTable table = new DataTable();
        ...
        [HttpPut]
        public JsonResult Put(Province prvn)
        {
            string query = @"
                    update dbo.Province set
                    ProvinceID = '" + prvn.ProvinceID + @"'
                    ,ProvinceName = '" + prvn.ProvinceName + @"'
                    where provinceID = " + prvn.ProvinceID + @"
                    ";
            DataTable table = new DataTable();
            string sqlDataSource = "Data Source=DESKTOP-2VQEA7I\\MSSQLSERVER01;Initial Catalog=GUY;Integrated Security=True;";
            SqlDataReader myReader;
