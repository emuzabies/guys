...
namespace GUY.Controllers
{
    ...
    public class ReasonController : ControllerBase
    {
        ...
        {
            string query = "select ReasonID, ReasonName from Reason; ";
        ...
        public JsonResult Put(Reason rea)
        {
            string query = @"
                    ...
                    ReasonID = '" + rea.ReasonID + @"'
                    ,ReasonName = '" + rea.ReasonName + @"'
                    where ReasonID = " + rea.ReasonID + @"
                    ";
            DataTable table = new DataTable();
            string sqlDataSource = "Data Source=DESKTOP-2VQEA7I\\MSSQLSERVER01;Initial Catalog=GUY;Integrated Security=True;";
            SqlDataReader myReader;
